...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let navController = tabVC.viewControllers![0] as! UINavigationController
        let liveFeedVC = navController.topViewController as! LiveFeedViewController
        // Set core data to controllers
        //liveFeedVC.managedObjectContext = self.managedObjectContext
        LiveFeedViewController.managedObjectContext =  self.managedObjectContext
        
        let historyNavController = tabVC.viewControllers![1] as! UINavigationController
        let historyVC = historyNavController.topViewController! as! HistoryTableViewController
        // Set core data to controllers
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "pgop6.PiWatch" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("PiWatch", withExtension: "momd")!
